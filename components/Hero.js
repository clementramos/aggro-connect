...
export default function Homepage() {
  return (
    <div className="flex max-h-screen flex-col items-center justify-between py-24 pr-24 bg-white bg-cover bg-no-repeat">
      {/* <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex bg-black">
          ...
          <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
            <a
              ...
              href="https://clementramos.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Site réalisé par <br></br> Clément Ramos
              <Image
                src="/avatar_1.png"
                alt="Clément Ramos"
